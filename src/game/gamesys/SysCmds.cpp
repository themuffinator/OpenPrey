...
void idGameLocal::InitConsoleCommands( void ) {
	...
	cmdSystem->AddCommand( "viewpos",				Cmd_Viewpos_f,				CMD_FL_GAME|CMD_FL_CHEAT,	"prints the current view position as a setviewpos command" );
