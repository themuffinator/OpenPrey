...
void hhBeamSystem::SetTargetEntity( idEntity *ent, int traceId, const idVec3 &offset ) {
	idVec3 origin;
	idMat3 axis;
...
void hhBeamSystem::SetTargetEntity( idEntity *ent, const char *boneName, const idVec3 &offset ) {
	idVec3 origin;
	idMat3 axis;
